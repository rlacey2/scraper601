...
var exchanges = {   
					...
					"coinranking" :  { exchange : "coinranking", currency : "dollars",	
...
router.get('/scrape', function(req, res){  // as /scrape?exchange=ise    /scrape?exchange=ftse350
...
router.get('/scrape/all', function(req, res){  // as /scrapall
